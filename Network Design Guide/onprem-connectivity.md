...
*Design phase #1. How to select a hybrid connectivity option for AVS.*
...
*Hybrid connectivity with ExpressRoute Global Reach. Traffic between AVS and on-premises sites does not transit through Azure VNets.*
